...
public class Member implements Serializable {
    ...
    @NotNull(message = "{OLA.model.Member.account.notNull.message}")
    @Size(min = 1, message = "{OLA.model.Member.account.notEmpty.message}")
    @Column
    @Id
    private String account;

    @NotNull(message = "{OLA.model.Member.passwd.notNull.message}")
    @Size(min = 1, message = "{OLA.model.Member.passwd.notEmpty.message}")
    @Column(name = "passwd")
    private String password;

    @NotNull(message = "{OLA.model.Member.name.notNull.message}")
    @Size(min = 1, message = "{OLA.model.Member.name.notEmpty.message}")
    @Column
    private String name;
