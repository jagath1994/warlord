...
public class CaptchaUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        if (captcha == null || captcha.trim().isEmpty()) {
            throw new AuthenticationServiceException(messageAccessor.getMessage("OLA.context.CaptchaUsernamePasswordAuthenticationFilter.notEmptyCaptcha"));
            ...
            throw new AuthenticationServiceException(messageAccessor.getMessage("OLA.context.CaptchaUsernamePasswordAuthenticationFilter.captchaNotValid"));
        }
