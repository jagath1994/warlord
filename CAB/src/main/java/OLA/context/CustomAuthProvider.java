...
public class CustomAuthProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication auth) throws AuthenticationException {
        ...
        logger.debug("{}: {}/{}", messageAccessor.getMessage("OLA.context.CustomAuthProvider.validateAccount"), account, passwd);
        ...
        if (userDetails == null) {
            ...
            throw new DisabledException(messageAccessor.getMessage("OLA.context.CustomUserService.userNotEnabled"));
        } else {
